...
////////////////////////how to run this application first start server app using green button on the server
////                    after that use run file option for the client to work